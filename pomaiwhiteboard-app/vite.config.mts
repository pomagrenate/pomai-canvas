  ...
  return {
    ...
    resolve: {
      alias: [
        ...
        },
        {
          ...
          replacement: path.resolve(
            __dirname,
            "../packages/pomaiwhiteboard/index.tsx",
          ),
        },
        {
          find: /^@excalidraw\/excalidraw\/(.*?)/,
    ...
    build: {
      ...
      rollupOptions: {
        output: {
          ...
          manualChunks(id) {
            if (
              id.includes("packages/pomaiwhiteboard/locales") &&
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          short_name: "Pomai Whiteboard",
          name: "Pomai Whiteboard",
          description:
            "Pomai Whiteboard is a collaborative whiteboard tool for real-time idea mapping and diagram sketching.",
          icons: [
            {
